    ...
    body: {
      ...
      data: {
        list: [
          ...
          {
            id: 3,
            title: "基于理性识别约束，对目标状态估计过程中的隐私保护环节进行识别。",
            publishStatus: 1,
            type: 1,
            publisherName: "系统管理员",
            level: "L",
          ...
          {
            id: 6,
            title: "从多源数据匹配机制库中确定目标画像对应的多源数据匹配机制成功。",
            publishStatus: 1,
            type: 2,
            publisherName: "系统管理员",
            level: "L",
          ...
          {
            id: 7,
            title: "基于理性识别约束，识别附加环节是否需要作为新的隐私保护环节。",
            publishStatus: 1,
            type: 3,
            publisherName: "系统管理员",
            level: "L",
