...
const LogAPI = {
   ...
   * @returns
   */
  getVisitCount(queryParams: VisitTrendQuery) {
    return request<any, VisitTrendVO>({
      url: `${LOG_BASE_URL}/visit-count`,
      method: "get",
      params: queryParams,
    });
  },
   ...
   * @returns
   */
  getVisitCount1(queryParams: VisitTrendQuery) {
    return request<any, VisitTrendVO>({
      url: `${LOG_BASE_URL}/visit-count1`,
      method: "get",
      params: queryParams,
    });
  },
   ...
   * @returns
   */
  getVisitCount2(queryParams: VisitTrendQuery) {
    return request<any, VisitTrendVO>({
      url: `${LOG_BASE_URL}/visit-count2`,
      method: "get",
      params: queryParams,
    });
  },
