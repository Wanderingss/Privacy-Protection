  ...
  <div class="app-container">
    ...
    <el-card shadow="hover" class="data-table">
      ...
      >
        ...
        <el-table-column label="审核人" prop="operator" width="120" />
        <el-table-column label="主题" prop="module" width="100" />
        <el-table-column label="隐私保护内容" prop="content" min-width="200" />
        <el-table-column label="IP 地址" prop="ip" width="150" />
        <el-table-column label="数据地区" prop="region" width="150" />
        <el-table-column label="终端系统" prop="browser" width="150" />
        <el-table-column label="数据上传量" prop="os" width="200" show-overflow-tooltip />
