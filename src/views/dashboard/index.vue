        ...
        <el-card shadow="never" class="h-full flex flex-col">
          <template #header>
            <div class="flex-x-between">
              <span class="text-gray">在线隐私保护节点</span>
        ...
        <el-skeleton :loading="visitStatsLoading" :rows="5" animated>
          ...
          <template v-if="!visitStatsLoading">
            <el-card shadow="never" class="h-full flex flex-col">
              <template #header>
                <div class="flex-x-between">
                  <span class="text-gray">客户端访问次数(UV)</span>
        ...
        <el-skeleton :loading="visitStatsLoading" :rows="5" animated>
          ...
          <template v-if="!visitStatsLoading">
            <el-card shadow="never" class="h-full flex flex-col">
              <template #header>
                <div class="flex-x-between">
                  <span class="text-gray">数据查询量(PV)</span>
...
const vesionList = ref<VersionItem[]>([
  {
    ...
    content: "针对智能汽车运行时的数据，进行了在线隐私保护，保证了用户数据安全。",
    link: "",
    tag: "里程碑",
  },
  {
    ...
    content: "基于其对目标状态估计过程中的隐私保护环节进行识别，并进行差分隐私保护，避免对智能设备进行状态估计的全部过程均进行数据隐私保护，实现了一种更加理性的保护方式，避免带来不必要的隐私保护资源的消耗，提升了隐私保护效率。",
    link: "",
    tag: "里程碑",
  },
  {
    ...
    content: "将多源数据映射进事件图谱，提取多源数据映射进后的事件图谱中独立的多个第一事件以及多组互相关联的多个第二事件的事件组。",
    link: "",
    tag: "里程碑",
  },
]);
